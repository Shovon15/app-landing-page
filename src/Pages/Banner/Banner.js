...
const Banner = () => {
  return (
    <div
      id="home"
      className="flex flex-col lg:flex-row px-5 md:px-10 py-5 bg-slate-300 min-h-max"
    >
      <div className="w-full lg:w-13/24 flex flex-col justify-center md:p-2 gap-4">
        ...
        <p className="font-extrabold text-start text-3xl md:text-5xl">
          Supercharge Your Retail Business with{" "}
          <span className="text-primary">Supershop's</span> All-in-One Retail
          Management Platform
        </p>
        ...
        <p className="text-lg text-start  text-wrap py-2">
          Seamlessly manage multi-channel sales, get real-time inventory For
          your brand new and pre-owned product business
        </p>
